...
const checkpointer = new JsonFileSaver(
  path.join(process.cwd(), "agent-memory.json")
);
...
const agent = createReactAgent({
  ...
  stateModifier:
    ...
    "identify the best asset to bridge and call execute_swap.\n\n" +
    ...
    "- Confirm bet details if amount > $50 by asking the user first\n" +
